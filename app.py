...
############################ Topic Modelling ################################
select= st.selectbox( '',('Emotion Analysis','Sentiment Analysis' , 'NamedEntity', 'Topic Modelling'),key='1')
...
# select= st.selectbox( '',('Emotion Analysis','Sentiment Analysis' , 'NamedEntity', 'Topic Modelling'))

# if select == 'Sentiment Analysis':
#     from transformers import XLNetLMHeadModel, XLNetTokenizer, AutoModelForSequenceClassification, pipeline
#     model_name = "finiteautomata/bertweet-base-sentiment-analysis"
